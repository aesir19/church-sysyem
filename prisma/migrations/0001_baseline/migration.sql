...
CREATE TABLE "public"."collections" (
    ...
    "is_tithes" BOOLEAN NOT NULL DEFAULT true,
    "collectedOn" DATE NOT NULL,
    "from_church" UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "public"."members" (
    ...
    "email" VARCHAR,
    "member_of" UUID NOT NULL DEFAULT auth.uid(),
    "archived_at" TIMESTAMPTZ(6),
    "archived_reason" TEXT,
    "wedding_anniversarry" DATE,
    "facebook_link" VARCHAR,
    "is_one_to_one_completed" BOOLEAN NOT NULL DEFAULT false,
    "is_turning_point_completed" BOOLEAN NOT NULL DEFAULT false,
    "is_baptized" BOOLEAN NOT NULL DEFAULT false,
    "marital_status" VARCHAR NOT NULL DEFAULT 'Single',
    "has_submitted_membership_form" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "public"."user_accounts" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "member_id" UUID,
    "role" VARCHAR NOT NULL DEFAULT 'unassigned',
...
-- AddForeignKey
ALTER TABLE "public"."collections" ADD CONSTRAINT "collections_from_church_fkey" FOREIGN KEY ("from_church") REFERENCES "public"."churches"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."collections" ADD CONSTRAINT "collections_from_fkey" FOREIGN KEY ("from") REFERENCES "public"."members"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."group_members" ADD CONSTRAINT "group_members_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."members" ADD CONSTRAINT "members_member_of_fkey" FOREIGN KEY ("member_of") REFERENCES "public"."churches"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."user_accounts" ADD CONSTRAINT "user_accounts_id_fkey" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."user_accounts" ADD CONSTRAINT "user_accounts_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE SET NULL ON UPDATE CASCADE;
